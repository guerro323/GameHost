...
public class Soloud : SoloudObject
{
    ...
    {
        var p = Soloud_getErrorString(objhandle, aErrorCode);
    ...
    {
        var p = Soloud_getBackendString(objhandle);
        return Marshal.PtrToStringAnsi(p);
    }
    ...
    internal static extern int
        Soloud_setSpeakerPosition(IntPtr aObjHandle, uint aChannel, float aX, float aY, float aZ);
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern uint Soloud_playEx(IntPtr aObjHandle, IntPtr aSound, float aVolume, float aPan, int aPaused,
        uint aBus);
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern uint Soloud_playClockedEx(IntPtr aObjHandle, double aSoundTime, IntPtr aSound, float aVolume,
        float aPan, uint aBus);
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern uint Soloud_play3dEx(IntPtr aObjHandle, IntPtr aSound, float aPosX, float aPosY, float aPosZ,
        float aVelX, float aVelY, float aVelZ, float aVolume, int aPaused, uint aBus);
    ...
    {
        return Soloud_play3dEx(objhandle, aSound.objhandle, aPosX, aPosY, aPosZ, aVelX, aVelY, aVelZ, aVolume, aPaused,
            aBus);
    }

    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern uint Soloud_play3dClockedEx(IntPtr aObjHandle, double aSoundTime, IntPtr aSound, float aPosX,
        float aPosY, float aPosZ, float aVelX, float aVelY, float aVelZ, float aVolume, uint aBus);
    ...
    {
        return Soloud_play3dClockedEx(objhandle, aSoundTime, aSound.objhandle, aPosX, aPosY, aPosZ, aVelX, aVelY, aVelZ,
            aVolume, aBus);
    }

    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern uint Soloud_playBackgroundEx(IntPtr aObjHandle, IntPtr aSound, float aVolume, int aPaused,
        uint aBus);
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void Soloud_oscillateFilterParameter(IntPtr aObjHandle, uint aVoiceHandle, uint aFilterId,
        uint aAttributeId, float aFrom, float aTo, double aTime);

    public void oscillateFilterParameter(uint aVoiceHandle, uint aFilterId, uint aAttributeId, float aFrom, float aTo,
        double aTime)
    {
    ...
    public float[] calcFFT()
    {
        ...
        var p = Soloud_calcFFT(objhandle);

        var buffer = new byte[4];
        for (var i = 0; i < ret.Length; ++i)
        {
            var f_bits = Marshal.ReadInt32(p, i * 4);
    ...
    {
        var ret = new float[256];
        var p = Soloud_getWave(objhandle);
    ...
    public void set3dListenerParameters(float aPosX, float aPosY, float aPosZ, float aAtX, float aAtY, float aAtZ,
        float aUpX, float aUpY, float aUpZ, float aVelocityX = 0.0f, float aVelocityY = 0.0f, float aVelocityZ = 0.0f)
    {
        Soloud_set3dListenerParametersEx(objhandle, aPosX, aPosY, aPosZ, aAtX, aAtY, aAtZ, aUpX, aUpY, aUpZ, aVelocityX,
            aVelocityY, aVelocityZ);
    }
    ...
    public void set3dSourceParameters(uint aVoiceHandle, float aPosX, float aPosY, float aPosZ, float aVelocityX = 0.0f,
...
public class BassboostFilter : SoloudObject
{
    ...
    {
        var p = BassboostFilter_getParamName(objhandle, aParamIndex);
        return Marshal.PtrToStringAnsi(p);
    }
...
public class BiquadResonantFilter : SoloudObject
{
    ...
    public string getParamName(uint aParamIndex)
    {
        var p = BiquadResonantFilter_getParamName(objhandle, aParamIndex);
        return Marshal.PtrToStringAnsi(p);
    }
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int BiquadResonantFilter_setParams(IntPtr aObjHandle, int aType, float aFrequency,
        float aResonance);
...
public class Bus : SoloudObject
{
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern uint Bus_playClockedEx(IntPtr aObjHandle, double aSoundTime, IntPtr aSound, float aVolume,
        float aPan);
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern uint Bus_play3dEx(IntPtr aObjHandle, IntPtr aSound, float aPosX, float aPosY, float aPosZ,
        float aVelX, float aVelY, float aVelZ, float aVolume, int aPaused);
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern uint Bus_play3dClockedEx(IntPtr aObjHandle, double aSoundTime, IntPtr aSound, float aPosX,
        float aPosY, float aPosZ, float aVelX, float aVelY, float aVelZ, float aVolume);

    public uint play3dClocked(double aSoundTime, SoloudObject aSound, float aPosX, float aPosY, float aPosZ,
        float aVelX = 0.0f, float aVelY = 0.0f, float aVelZ = 0.0f, float aVolume = 1.0f)
    {
        return Bus_play3dClockedEx(objhandle, aSoundTime, aSound.objhandle, aPosX, aPosY, aPosZ, aVelX, aVelY, aVelZ,
            aVolume);
    }
...
public class DCRemovalFilter : SoloudObject
{
    ...
    public string getParamName(uint aParamIndex)
    {
        var p = DCRemovalFilter_getParamName(objhandle, aParamIndex);
        return Marshal.PtrToStringAnsi(p);
    }
...
public class EchoFilter : SoloudObject
{
    ...
    public string getParamName(uint aParamIndex)
    {
        var p = EchoFilter_getParamName(objhandle, aParamIndex);
        return Marshal.PtrToStringAnsi(p);
    }
...
public class FFTFilter : SoloudObject
{
    ...
    public string getParamName(uint aParamIndex)
    {
        var p = FFTFilter_getParamName(objhandle, aParamIndex);
        return Marshal.PtrToStringAnsi(p);
    }
...
public class FlangerFilter : SoloudObject
{
    ...
    public string getParamName(uint aParamIndex)
    {
        var p = FlangerFilter_getParamName(objhandle, aParamIndex);
        return Marshal.PtrToStringAnsi(p);
    }
...
public class FreeverbFilter : SoloudObject
{
    ...
    public string getParamName(uint aParamIndex)
    {
        var p = FreeverbFilter_getParamName(objhandle, aParamIndex);
        return Marshal.PtrToStringAnsi(p);
    }
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int FreeverbFilter_setParams(IntPtr aObjHandle, float aMode, float aRoomSize, float aDamp,
        float aWidth);
...
public class LofiFilter : SoloudObject
{
    ...
    public string getParamName(uint aParamIndex)
    {
        var p = LofiFilter_getParamName(objhandle, aParamIndex);
        return Marshal.PtrToStringAnsi(p);
    }
...
public class Monotone : SoloudObject
{
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int Monotone_loadMemEx(IntPtr aObjHandle, IntPtr aMem, uint aLength, int aCopy,
        int aTakeOwnership);
...
public class Noise : SoloudObject
{
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void Noise_setOctaveScale(IntPtr aObjHandle, float aOct0, float aOct1, float aOct2,
        float aOct3, float aOct4, float aOct5, float aOct6, float aOct7, float aOct8, float aOct9);

    public void setOctaveScale(float aOct0, float aOct1, float aOct2, float aOct3, float aOct4, float aOct5,
        float aOct6, float aOct7, float aOct8, float aOct9)
    {
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void Noise_set3dAttenuation(IntPtr aObjHandle, uint aAttenuationModel,
        float aAttenuationRolloffFactor);
...
public class Openmpt : SoloudObject
{
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int Openmpt_loadMemEx(IntPtr aObjHandle, IntPtr aMem, uint aLength, int aCopy,
        int aTakeOwnership);
...
public class RobotizeFilter : SoloudObject
{
    ...
    public string getParamName(uint aParamIndex)
    {
        var p = RobotizeFilter_getParamName(objhandle, aParamIndex);
        return Marshal.PtrToStringAnsi(p);
    }
...
public class Sfxr : SoloudObject
{
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int Sfxr_loadParamsMemEx(IntPtr aObjHandle, IntPtr aMem, uint aLength, int aCopy,
        int aTakeOwnership);
...
public class TedSid : SoloudObject
{
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int TedSid_loadMemEx(IntPtr aObjHandle, IntPtr aMem, uint aLength, int aCopy,
        int aTakeOwnership);
...
public class Wav : SoloudObject
{
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int Wav_loadMemEx(IntPtr aObjHandle, IntPtr aMem, uint aLength, int aCopy,
        int aTakeOwnership);
    ...
    internal static extern int Wav_loadRawWaveEx(IntPtr aObjHandle, float[] aMem, uint aLength, float aSamplerate,
        uint aChannels, int aCopy, int aTakeOwnership);

    public int loadRawWave(float[] aMem, uint aLength, float aSamplerate = 44100.0f, uint aChannels = 1, int aCopy = 0,
        int aTakeOwnership = 1)
    {
...
public class WaveShaperFilter : SoloudObject
{
    ...
    public string getParamName(uint aParamIndex)
    {
        var p = WaveShaperFilter_getParamName(objhandle, aParamIndex);
        return Marshal.PtrToStringAnsi(p);
    }
...
public class WavStream : SoloudObject
{
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int WavStream_loadMemEx(IntPtr aObjHandle, IntPtr aData, uint aDataLen, int aCopy,
        int aTakeOwnership);
    ...
    [DllImport(DLL_PATH, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int
        WavStream_loadToMem(IntPtr aObjHandle, [MarshalAs(UnmanagedType.LPStr)] string aFilename);
    ...
    internal static extern void
        WavStream_set3dMinMaxDistance(IntPtr aObjHandle, float aMinDistance, float aMaxDistance);
